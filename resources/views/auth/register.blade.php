    ...
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input type="text" class="form-control m-b-md @error('name') is-invalid @enderror" placeholder="Enter Name" name="name">
                @error('name')
            ...
            <div class="auth-submit">
                <button type="submits" class="btn btn-primary">Sign Up</button>
            </div>
