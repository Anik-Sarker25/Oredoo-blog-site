                ...
                @forelse ($posts as $post)
                    ...
                    <div class="post-list post-list-style2">
                        <div class="post-list-image">
                            <a href="{{ route('category.single.blog', $post->id)}}">
                                <img src="{{ asset('uploads/blog')}}/{{ $post->image }}" alt="post-image">
                            </a>
                        </div>
                        <div class="post-list-content">
                            <h3 class="entry-title">
                                <a href="{{ route('category.single.blog', $post->id)}}">{{ $post->title }}</a>
                            </h3>
                            <ul class="entry-meta">
                            ...
                            <div class="post-btn">
                                <a href="{{ route('category.single.blog', $post->id)}}" class="btn-read-more">Continue Reading <i class="las la-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                @empty
